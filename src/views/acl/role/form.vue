  ...
  <div class="app-container">
    <el-form ref="role" :model="role" :rules="validateRules" label-width="120px">
      ...
      <el-form-item label="角色描述" prop="roleDescription">
        <el-input v-model="role.roleDescription"/>
      </el-form-item>
    <el-form-item>
  ...
  data() {
    return {
      ...
      validateRules: {
        ...
        roleCode: [{ required: true, trigger: 'blur', message: '角色code必须输入' }],
        roleDescription: [{ required: true, trigger: 'blur', message: '角色描述必须输入' }]
      }
    }
  },
